...
<html lang="en">
  ...
  <body>
    <div class="container pt-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <h2>Verified Registered Students List</h2>
            </div>
            <div class="col-md-12">
            <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('lecturers/'.$student->nim.'/edit') }}" class="btn btn-warning btn-sm">Edit</a>
                                <form onsubmit="return confirm('Are you sure you want to delete this data?')" 
                                class="d-inline" action="{{ url('lecturers/'.$student->nim) }}" method="post">
                                    @csrf
                                    @method('DELETE')
